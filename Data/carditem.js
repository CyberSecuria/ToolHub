export const cardsData = [
  ...
  
   {
    ...
    platform: [
      { name: "Windows", icon: "Assets/Platform Icon/icons8-windows-os.svg" },
      { name: "MacOS", icon: "Assets/Platform Icon/icons8-mac-os.svg" },
      { name: "Linux", icon: "Assets/Platform Icon/linux-svgrepo-com.svg" }
    ],
    rating: 5,
...

   {
    ...
    platform: [
      ...
      { name: "MacOS", icon: "Assets/Platform Icon/icons8-mac-os.svg" },
      { name: "Linux", icon: "Assets/Platform Icon/linux-svgrepo-com.svg" },
      { name: "android", icon: "Assets/Platform Icon/icons8-android.svg" },
      { name: "iOS", icon: "Assets/Platform Icon/icons8-ios.svg" }
    ],
    rating: 3,
    link: "https://slack.com/intl/fr-ch/",
    device: "Web, Desktop, Mobile"
   },

   {
    ...
    rating: 4,
    link: "https://www.adobe.com/ch_fr/products/photoshop.html",
